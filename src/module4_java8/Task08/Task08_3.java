...
public class Task08_3 {
	...
	public static void main(String[] args) {
		...
		list.stream().filter( product -> product.getPrice()>1000 && product.getCategory().equalsIgnoreCase("electronics"))
		.map(product -> new Product(product.getName().toUpperCase(), product.getPrice(), product.getCategory().toUpperCase(), product.getGrade()))

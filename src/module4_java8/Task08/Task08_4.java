...
public class Task08_4 {
	...
	public static void main(String[] args) {
		...
		long countOfElectronicsProducts = list.stream().filter(product -> product.getCategory().equalsIgnoreCase("electronics"))
		.count();
		
		System.out.println(countOfElectronicsProducts);
